...
def generateWorkflow():
	...
	if os.path.exists('home/data/binner_output_dataDictionary.parquet'):
	...
	if os.path.exists('home/data/mapping_output_dataDictionary.parquet'):
	...
	if os.path.exists('home/data/mathOperation_output_dataDictionary.parquet'):
