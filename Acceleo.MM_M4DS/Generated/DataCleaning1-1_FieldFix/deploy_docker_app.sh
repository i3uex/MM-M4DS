...
cp /home/binner_output_dataDictionary.csv "$(pwd)/data/"




docker run -it --rm --name docker_fieldfix --network host --mount type=bind,source="$(pwd)/data",target=home/data ubuntu_22_04:latest
