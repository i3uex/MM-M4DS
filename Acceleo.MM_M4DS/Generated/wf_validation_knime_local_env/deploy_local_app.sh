...
TRANSFORMATIONS_SCRIPT="transformations_Job_Model_data_set_with_metanode_KNIME_"
WORKFLOW_SCRIPT="dataProcessing_Job_Model_data_set_with_metanode_KNIME_"
...
if [ ! -d "./wf_validation_knime/data" ]; then
    mkdir ./wf_validation_knime/data/
fi

cp -R /home/carlos/Escritorio/datasets/* ./wf_validation_knime/data/


cp $CONTRACTS_SCRIPT.py ./wf_validation_knime/generated_code/
cp $TRANSFORMATIONS_SCRIPT.py ./wf_validation_knime/generated_code/
cp $WORKFLOW_SCRIPT.py ./wf_validation_knime/generated_code/
