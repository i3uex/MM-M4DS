...
def generateWorkflow():
	...
	if os.path.exists('/wf_validation_python/data/imputeMissingByMean(avg_income, distance)_output_dataDictionary.parquet'):
	...
	if os.path.exists('/wf_validation_python/data/imputeMissingByLinearInterpolation(satscore)_output_dataDictionary.parquet'):
	...
	if os.path.exists('/wf_validation_python/data/stringToNumber_output_dataDictionary.parquet'):
	...
	if os.path.exists('/wf_validation_python/data/numericOutliers_output_dataDictionary.parquet'):
	...
	if os.path.exists('/wf_validation_python/data/numericBinner_output_dataDictionary.parquet'):
	...
	if os.path.exists('/wf_validation_python/data/pmml_output_dataDictionary.parquet'):
		pmml_output_dataDictionary_df=pd.read_parquet('/wf_validation_python/data/pmml_output_dataDictionary.parquet')
