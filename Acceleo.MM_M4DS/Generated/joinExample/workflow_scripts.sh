CONTRACTS_SCRIPT="workflows.contracts_Job_join_example"
TRANSFORMATIONS_SCRIPT="workflows.transformations_Job_join_example"
WORKFLOW_SCRIPT="workflows.dataProcessing_Job_join_example"
