CONTRACTS_SCRIPT="workflows.contracts_Job_DATA_CLEANING_Workflow1-1"
TRANSFORMATIONS_SCRIPT="workflows.transformations_Job_DATA_CLEANING_Workflow1-1"
WORKFLOW_SCRIPT="workflows.dataProcessing_Job_DATA_CLEANING_Workflow1-1"
