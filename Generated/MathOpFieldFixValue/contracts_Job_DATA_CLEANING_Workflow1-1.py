...
def generateWorkflow():
	...
	if os.path.exists('esta/data/output/Rule_Engine_output_dataDictionary.parquet'):
	...
	if os.path.exists('esta/data/output/String_Manipulation_output_dataDictionary.parquet'):
	...
	if os.path.exists('esta/data/output/Math_Formula_output_dataDictionary.parquet'):
