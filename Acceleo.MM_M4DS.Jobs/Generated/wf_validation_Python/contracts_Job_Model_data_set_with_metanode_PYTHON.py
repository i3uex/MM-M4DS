...
def generateWorkflow():
	...
	if os.path.exists('./python_dataDictionaries/missing_output_dataDictionary.csv'):		#If the output DataDictionary exists, we store it
		imputeMissingByMostFrequent_sex_IRISCHOOL_ETHNICITY__output_dataDictionary_df=pd.read_csv('./python_dataDictionaries/missing_output_dataDictionary.csv', sep = ',')
	...
	#-----------------New DataProcessing-----------------
	imputeMissingByFixValue_ACADEMIC_INTEREST_2_ACADEMIC_INTEREST_1__input_dataDictionary_df=pd.read_csv('./python_dataDictionaries/missing_input_dataDictionary.csv', sep=',')

	if os.path.exists('./python_dataDictionaries/missing_output_dataDictionary.csv'):		#If the output DataDictionary exists, we store it
		imputeMissingByFixValue_ACADEMIC_INTEREST_2_ACADEMIC_INTEREST_1__output_dataDictionary_df=pd.read_csv('./python_dataDictionaries/missing_output_dataDictionary.csv', sep = ',')
	...
	#-----------------New DataProcessing-----------------
	imputeMissingByMean_avg_income_distance__input_dataDictionary_df=pd.read_csv('./python_dataDictionaries/missing_input_dataDictionary.csv', sep=',')

	if os.path.exists('./python_dataDictionaries/missing_output_dataDictionary.csv'):		#If the output DataDictionary exists, we store it
		imputeMissingByMean_avg_income_distance__output_dataDictionary_df=pd.read_csv('./python_dataDictionaries/missing_output_dataDictionary.csv', sep = ',')
	...
	#-----------------New DataProcessing-----------------
	imputeMissingByLinearInterpolation_satscore__input_dataDictionary_df=pd.read_csv('./python_dataDictionaries/missing_input_dataDictionary.csv', sep=',')

	if os.path.exists('./python_dataDictionaries/missing_output_dataDictionary.csv'):		#If the output DataDictionary exists, we store it
		imputeMissingByLinearInterpolation_satscore__output_dataDictionary_df=pd.read_csv('./python_dataDictionaries/missing_output_dataDictionary.csv', sep = ',')
	...
	#-----------------New DataProcessing-----------------
	rowFilterRange_init_span__input_dataDictionary_df=pd.read_csv('./python_dataDictionaries/missing_output_dataDictionary.csv', sep=',')

	if os.path.exists('./python_dataDictionaries/rowFilter_output_dataDictionary.csv'):		#If the output DataDictionary exists, we store it
		rowFilterRange_init_span__output_dataDictionary_df=pd.read_csv('./python_dataDictionaries/rowFilter_output_dataDictionary.csv', sep = ',')
	...
	#-----------------New DataProcessing-----------------
	columnFilter_TRAVEL_INIT_CNTCTS_REFERRAL_CNCTS_telecq_interest_stuemail_CONTACT_CODE1__input_dataDictionary_df=pd.read_csv('./python_dataDictionaries/rowFilter_output_dataDictionary.csv', sep=',')

	if os.path.exists('./python_dataDictionaries/columnFilter_output_dataDictionary.csv'):		#If the output DataDictionary exists, we store it
		columnFilter_TRAVEL_INIT_CNTCTS_REFERRAL_CNCTS_telecq_interest_stuemail_CONTACT_CODE1__output_dataDictionary_df=pd.read_csv('./python_dataDictionaries/columnFilter_output_dataDictionary.csv', sep = ',')
	...
	#-----------------New DataProcessing-----------------
	Mapping_TERRITORY__input_dataDictionary_df=pd.read_csv('./python_dataDictionaries/columnFilter_output_dataDictionary.csv', sep=',')

	if os.path.exists('./python_dataDictionaries/ruleEngine_territory_output_dataDictionary.csv'):		#If the output DataDictionary exists, we store it
		Mapping_TERRITORY__output_dataDictionary_df=pd.read_csv('./python_dataDictionaries/ruleEngine_territory_output_dataDictionary.csv', sep = ',')
	...
	#-----------------New DataProcessing-----------------
	mapping_Instate__input_dataDictionary_df=pd.read_csv('./python_dataDictionaries/ruleEngine_territory_output_dataDictionary.csv', sep=',')

	if os.path.exists('./python_dataDictionaries/ruleEngine_instate_output_dataDictionary.csv'):		#If the output DataDictionary exists, we store it
		mapping_Instate__output_dataDictionary_df=pd.read_csv('./python_dataDictionaries/ruleEngine_instate_output_dataDictionary.csv', sep = ',')
	...
	#-----------------New DataProcessing-----------------
	stringToNumber_TERRITORY_Instate__input_dataDictionary_df=pd.read_csv('./python_dataDictionaries/ruleEngine_instate_output_dataDictionary.csv', sep=',')
	...
	if os.path.exists('./python_dataDictionaries/stringToNumber_output_dataDictionary.csv'):		#If the output DataDictionary exists, we store it
		stringToNumber_TERRITORY_Instate__output_dataDictionary_df=pd.read_csv('./python_dataDictionaries/stringToNumber_output_dataDictionary.csv', sep = ',')
	...
	#-----------------New DataProcessing-----------------
	imputeOutlierByClosest_avg_income_distance_Instate__input_dataDictionary_df=pd.read_csv('./python_dataDictionaries/stringToNumber_output_dataDictionary.csv', sep=',')

	if os.path.exists('./python_dataDictionaries/numericOutliers_output_dataDictionary.csv'):		#If the output DataDictionary exists, we store it
		imputeOutlierByClosest_avg_income_distance_Instate__output_dataDictionary_df=pd.read_csv('./python_dataDictionaries/numericOutliers_output_dataDictionary.csv', sep = ',')
	...
	#-----------------New DataProcessing-----------------
	binner_TOTAL_CONTACTS_SELF_INIT_CNTCTS_SOLICITED_CNTCTS__input_dataDictionary_df=pd.read_csv('./python_dataDictionaries/numericOutliers_output_dataDictionary.csv', sep=',')
	...
	if os.path.exists('./python_dataDictionaries/numericBinner_output_dataDictionary.csv'):		#If the output DataDictionary exists, we store it
		binner_TOTAL_CONTACTS_SELF_INIT_CNTCTS_SOLICITED_CNTCTS__output_dataDictionary_df=pd.read_csv('./python_dataDictionaries/numericBinner_output_dataDictionary.csv', sep = ',')
	...
	#-----------------New DataProcessing-----------------
	binner_TERRITORY__input_dataDictionary_df=pd.read_csv('./python_dataDictionaries/numericOutliers_output_dataDictionary.csv', sep=',')

	if os.path.exists('./python_dataDictionaries/numericBinner_output_dataDictionary.csv'):		#If the output DataDictionary exists, we store it
		binner_TERRITORY__output_dataDictionary_df=pd.read_csv('./python_dataDictionaries/numericBinner_output_dataDictionary.csv', sep = ',')
	...
	#-----------------New DataProcessing-----------------
	binner_satscore__input_dataDictionary_df=pd.read_csv('./python_dataDictionaries/numericOutliers_output_dataDictionary.csv', sep=',')

	if os.path.exists('./python_dataDictionaries/numericBinner_output_dataDictionary.csv'):		#If the output DataDictionary exists, we store it
		binner_satscore__output_dataDictionary_df=pd.read_csv('./python_dataDictionaries/numericBinner_output_dataDictionary.csv', sep = ',')
	...
	#-----------------New DataProcessing-----------------
	binner_avg_income__input_dataDictionary_df=pd.read_csv('./python_dataDictionaries/numericOutliers_output_dataDictionary.csv', sep=',')

	if os.path.exists('./python_dataDictionaries/numericBinner_output_dataDictionary.csv'):		#If the output DataDictionary exists, we store it
		binner_avg_income__output_dataDictionary_df=pd.read_csv('./python_dataDictionaries/numericBinner_output_dataDictionary.csv', sep = ',')
